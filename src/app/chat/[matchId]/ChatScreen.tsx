...
export function ChatScreen({
  ...
  return (
    <div className="flex h-dvh flex-col">
      ...
      <div className="app-shell flex-1 overflow-y-auto pb-4 pt-9">
        <SafetyNotice />
        ...
        {messages.length === 0 && loaded && (
          <div className="panel mx-auto mt-2 max-w-[340px] p-5 text-center">
            ...
            <p className="mt-3 text-[12.5px] leading-snug text-cocoa">
              ...
              >
                ...
                <span
                  className={`mt-1 block text-right text-[10.5px] ${
                    message.mine ? "text-white/70" : "text-cocoa"
                  }`}
                >
          ...
          {chatBanned ? (
            ...
            <form onSubmit={send} className="flex items-end gap-2">
              <textarea
                ...
                className="field max-h-28 min-h-[50px] flex-1 resize-none rounded-[25px] bg-vanilla py-3.5 focus:field-focus"
              />
              <button
                type="submit"
